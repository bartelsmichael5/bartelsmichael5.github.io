(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 170, 170, 6, 0.7);
        collectable.create(type.db, 285, 470, 12, 0.9);
        collectable.create(type.max, 75, 0, 24, 0.7);
        
        collectable.create(type.grace, 770, 75);
